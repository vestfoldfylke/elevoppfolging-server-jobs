...
```json5
{
  ...
  "Values": {
    ...
    "FINT_ADDRESS_BLOCK": "FORTROLIG ADRESSE,STRENGT FORTROLIG ADRESSE", // addresses used on persons with an active address block in FINT. This is used to set the "hasActiveAddressBlock" property on appStudents. (default: "FORTROLIG ADRESSE,STRENGT FORTROLIG ADRESSE")
